...
def encrypt_files(file, ciphersystem, cipherkeyset):
    if ciphersystem == "XOR":
        ...
        DES.des_cipher(file, cipherkeyset, 'E')
    elif ciphersystem == "VIG":
        VIG.vig_cipher(file, cipherkeyset, 'E')
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        print("""Incorrect Usage. Usage: python3 RBAencryption.py [directory] [ciphersystem] [cipherkeyset]
